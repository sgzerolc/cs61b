...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        while (index == min(index, par)) {
           swap(index, par);
           index = par;
           par = parentIndex(index);
           if (index == 1) {
               break; //reach root
           }
        }
    ...
    private void sink(int index) {
        ...
        int Rchild = rightIndex(index);
        int Lchild = leftIndex(index);
        int smaller = min(Rchild, Lchild);
<<<<<<< HEAD
        // bubble down through the smaller of the two children.
=======
>>>>>>> 606ebdb (pq local test passed)

        if (index == min(index, Rchild) && index == min(index, Lchild)) {
            return;
        } else { //index is not the smallest, sink either side
            swap(index, smaller);
            sink(smaller);
        }
    }
    ...
    public void insert(T item, double priority) {
        ...
        Node end = new Node(item, priority);
        contents[size + 1] = end;
        size += 1;
        if (size > 1) {
<<<<<<< HEAD
            swim(size); //swim the insert element at the tail
=======
            swim(size);
>>>>>>> 606ebdb (pq local test passed)
        }
...
>>>>>>> 606ebdb (pq local test passed)
    ...
    public void changePriority(T item, double priority) {
        int i = 1; //contents[0] = null on purpose.
        while (i <= this.size()) { //edge case: OffbyOne error
            if (getNode(i).item().equals(item)) {
                // change: better priority
                if (contents[i].myPriority < priority) {
                    contents[i].myPriority = priority;
                    sink(i);
                } else if (contents[i].myPriority > priority){
                    //change: worse priority
                    contents[i].myPriority = priority;
                    swim(i);
                } else{
                    contents[i].myPriority = priority;
...
//    }
    ...
    public void testSwim() {
        ...
        //test case: change the bottom item of the right branch
...
//        assertEquals("x7", pq.contents[7].myItem);
        ...
        //test case: edge case: change the root
        //error1: swim(1) by which contents[0] are taken
//        pq.contents[1].myPriority = 0;
//        System.out.println("PQ before swimming:");
//        System.out.println(pq);
//
//        // Swim x1 upwards. It should still be the root.
//
//        pq.swim(1);
//        System.out.println("PQ after swimming:");
//        System.out.println(pq);
...
//        assertEquals("x7", pq.contents[7].myItem);
        ...
        //test case: left branch
        pq.contents[4].myPriority = 0;
        System.out.println("PQ before swimming:");
        System.out.println(pq);
...
//        assertEquals("x7", pq.contents[7].myItem);
        ...
        //test case: change medium
//        pq.contents[3].myPriority = 10;
//        System.out.println("PQ before sinking:");
//        System.out.println(pq);
//
//        // Sink one in the middle
//        pq.sink(3);
//        System.out.println("PQ after sinking:");
//        System.out.println(pq);
//        assertEquals("x1", pq.contents[1].myItem);
...
//        assertEquals("x7", pq.contents[7].myItem);
        ...
        //test case: change bottom
        pq.contents[6].myPriority = 10;
        System.out.println("PQ before sinking:");
        System.out.println(pq);
...
//        assertEquals("d", pq.contents[10].myItem);
        ...
        //test case: when two items have the same priority
        pq.insert("x1", 3);
        assertEquals("x1", pq.contents[1].myItem);
        ...
        System.out.println("pq after inserting 3 items: ");
        System.out.println(pq);
    ...
    public void testInsertAndRemoveOnce() {
        ...
        //test case: edge case: insert one item and remove it:
        //error2:  Cannot sink or swim nodes with index greater than current size.

//        pq.insert("x1", 1);
////        pq.insert("x2", 2);
////        pq.insert("x3", 3);
//        String removed = pq.removeMin();
//        assertEquals("x1", removed);
...
//    }
    ...
    public void testChangePriority() {
        ...
        //test case: change the priority of a node for the better
//        pq.changePriority("x1", 10);
//        System.out.println("PQ after changing for better:");
//        System.out.println(pq);
//        assertEquals("x2", pq.contents[1].myItem);
//        assertEquals("x4", pq.contents[2].myItem);
//        assertEquals("x3", pq.contents[3].myItem);
...
//        assertEquals("x7", pq.contents[7].myItem);
        ...
        //test case: change the priority of a node for the worse
        pq.changePriority("x7", 0);
        System.out.println("PQ after changing for worse:");
        System.out.println(pq);
        assertEquals("x7", pq.contents[1].myItem);
        assertEquals("x2", pq.contents[2].myItem);
        assertEquals("x1", pq.contents[3].myItem);
        assertEquals("x4", pq.contents[4].myItem);
        assertEquals("x5", pq.contents[5].myItem);
        assertEquals("x6", pq.contents[6].myItem);
        assertEquals("x3", pq.contents[7].myItem);
    }
